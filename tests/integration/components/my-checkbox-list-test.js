...
test("it renders", function(assert) {
    ...
    this.render(hbs`{{my-checkbox-list content=items optionValuePath="value" optionLabelPath="label"}}`);
...
test("it checks proper elements", function(assert) {
    ...
    this.render(hbs`{{my-checkbox-list content=items selection=selection optionValuePath="value" optionLabelPath="label"}}`);
